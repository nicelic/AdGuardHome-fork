...
import CertificateManager from '../../containers/CertificateManager';
...
const ROUTES = [
    ...
    {
        path: FILTERS_URLS.domain_blacklist,
        component: DomainBlacklist,
    },
    {
        path: FILTERS_URLS.domain_whitelist,
