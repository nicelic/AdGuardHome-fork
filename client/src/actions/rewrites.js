 ...
 */
export const updateRewrite = (config) => async (dispatch, getState) => {
...
export const getRewriteSettings = () => async (dispatch) => {
...
export const updateRewriteSettings = (config) => async (dispatch) => {
