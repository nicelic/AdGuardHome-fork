...
const install = handleActions({
    [actions.getDefaultAddressesRequest.toString()]: (state) => ({
        ...state,
        processingDefault: true,
    }),
    [actions.getDefaultAddressesFailure.toString()]: (state) => ({
        ...state,
        processingDefault: false,
    }),
    [actions.getDefaultAddressesSuccess.toString()]: (state, { payload }) => {
    ...
    [actions.nextStep.toString()]: (state) => ({
        ...state,
        step: state.step + 1,
    }),
    [actions.prevStep.toString()]: (state) => ({
        ...state,
        step: state.step - 1,
    }),
    [actions.setAllSettingsRequest.toString()]: (state) => ({
        ...state,
        processingSubmit: true,
    }),
    [actions.setAllSettingsFailure.toString()]: (state) => ({
        ...state,
        processingSubmit: false,
    }),
    [actions.setAllSettingsSuccess.toString()]: (state) => ({
        ...state,
        processingSubmit: false,
    }),
    [actions.checkConfigRequest.toString()]: (state) => ({
        ...state,
        processingCheck: true,
    }),
    [actions.checkConfigFailure.toString()]: (state) => ({
        ...state,
        processingCheck: false,
    }),
    [actions.checkConfigSuccess.toString()]: (state, { payload }) => {
