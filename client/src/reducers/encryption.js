...
const normalizeEncryptionPayload = (state, payload) => ({
    ...state,
    ...payload,
...
const encryption = handleActions({
    [actions.getTlsStatusRequest.toString()]: (state) => ({
        ...state,
        processing: true,
    }),
    [actions.getTlsStatusFailure.toString()]: (state) => ({
        ...state,
        processing: false,
    }),
    [actions.getTlsStatusSuccess.toString()]: (state, { payload }) => {
    ...
    [actions.setTlsConfigRequest.toString()]: (state) => ({
        ...state,
        processingConfig: true,
    }),
    [actions.setTlsConfigFailure.toString()]: (state) => ({
        ...state,
        processingConfig: false,
    }),
    [actions.setTlsConfigSuccess.toString()]: (state, { payload }) => {
        const newState = normalizeEncryptionPayload(state, {
            ...payload,
            processingConfig: false,
        });
    ...
    [actions.validateTlsConfigRequest.toString()]: (state) => ({
        ...state,
        processingValidate: true,
    }),
    [actions.validateTlsConfigFailure.toString()]: (state) => ({
        ...state,
    ...
    [actions.validateTlsConfigSuccess.toString()]: (state, { payload }) => {
        const { issuer = '', key_type = '', not_after = '', not_before = '', subject = '', warning_validation = '', dns_names = '', can_apply = false, panel_issuer = '', panel_key_type = '', panel_not_after = '', panel_not_before = '', panel_subject = '', panel_warning_validation = '', panel_dns_names = '', panel_can_apply = false, ...values } = payload;
        const newState = normalizeEncryptionPayload(state, {
            ...values,
            issuer,
            key_type,
