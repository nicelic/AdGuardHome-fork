...
export type EncryptionPathPair = {
    certificate_path: string;
    private_key_path: string;
};

export type EncryptionPathPairStatus = EncryptionPathPair & {
    issuer: string;
    key_type: string;
    not_after: string;
    not_before: string;
...
export type EncryptionData = {
    ...
    panel_issuer: string;
    key_type: string;
    panel_key_type: string;
    not_after: string;
    panel_not_after: string;
    not_before: string;
    panel_not_before: string;
    ...
    subject: string;
    panel_subject: string;
    valid_chain: boolean;
    panel_valid_chain: boolean;
    valid_key: boolean;
    panel_valid_key: boolean;
    valid_cert: boolean;
    panel_valid_cert: boolean;
    valid_pair: boolean;
    panel_valid_pair: boolean;
    status_cert: string;
    status_key: string;
    private_key: string;
    ...
    server_name: string;
    warning_validation: string;
    panel_warning_validation: string;
    ...
    certificate_key_pair_statuses: EncryptionPathPairStatus[];
    panel_certificate_key_pair_statuses: EncryptionPathPairStatus[];
    private_key_path: string;
    panel_private_key_path: string;
    private_key_saved: boolean;
    panel_private_key_saved: boolean;
    dns_assigned_certificate_ids: number[];
    panel_assigned_certificate_ids: number[];
