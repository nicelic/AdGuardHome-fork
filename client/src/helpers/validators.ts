 ...
 * @returns {undefined|string}
 */
export const validatePairedValue = (value: any, pairedValue: any) => {
    const formattedValue = typeof value === 'string' ? value.trim() : value;
...
export const validateServerName = (value: any) => {
    ...
    if (formattedValue && !R_HOST.test(formattedValue)) {
 ...
 * @returns {undefined|string}
 */
export const validateURLPathPrefix = (value: any) => {
    if (!value) {
        return undefined;
    }
 ...
 * @returns {undefined|string}
 */
export const validateAbsolutePath = (value: any) => {
...
export const validatePlainDns = (value: any, allValues: any) => {
    ...
    const hasEncryptedDNSProtocol =
        !!allValues.port_https ||
