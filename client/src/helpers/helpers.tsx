...
export const getClientTransportLabel = (clientTransport?: string) =>
    clientTransport ? `(${clientTransport.toUpperCase()})` : '';

export const formatClientProtocol = (
    clientProto: string,
    clientTransport?: string,
    translate: (key: string) => string = i18n.t.bind(i18n),
) => {
...
export const getPanelPagePath = (page: string, panelPath = '/') => {
...
export const getSpecialFilterName = (filterId: any) => {
    switch (filterId) {
        ...
        case SPECIAL_FILTER_ID.DOMAIN_WHITELIST:
            return i18n.t('domain_whitelist');
        case SPECIAL_FILTER_ID.DOMAIN_BLACKLIST:
            return i18n.t('domain_blacklist');
        default:
