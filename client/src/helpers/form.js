 ...
 * @returns {*|number}
 */
export const toFloatNumber = (value) => value && parseFloat(value);
/**
 * @param value {string}
 * @returns {boolean}
 */
export const isValidAbsolutePath = (value) => R_WIN_ABSOLUTE_PATH.test(value) || R_UNIX_ABSOLUTE_PATH.test(value);
/**
 * @param value {string}
 * @returns {*|string}
 */
