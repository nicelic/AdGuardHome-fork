...
export const REPOSITORY = {
    URL: 'https://github.com/nicelic/AdGuardHome-fork',
    TRACKERS_DB: 'https://github.com/nicelic/AdGuardHome-fork/tree/main/client/src/helpers/trackers/trackers.json',
    ISSUES: 'https://github.com/nicelic/AdGuardHome-fork/issues/new/choose',
};
export const CLIENT_ID_LINK = 'https://github.com/nicelic/AdGuardHome-fork/wiki/Clients#clientid';
export const MANUAL_UPDATE_LINK = 'https://github.com/nicelic/AdGuardHome-fork/wiki/FAQ#manual-update';
export const PORT_53_FAQ_LINK = 'https://github.com/nicelic/AdGuardHome-fork/wiki/FAQ#bindinuse';
export const PRIVACY_POLICY_LINK = 'https://link.adtidy.org/forward.html?action=privacy&from=ui&app=home';
export const UPSTREAM_CONFIGURATION_WIKI_LINK = 'https://github.com/nicelic/AdGuardHome-fork/wiki/Configuration#upstreams';
...
export const DEFAULT_UPSTREAM_DNS = 'tls://1.1.1.1\ntls://1.0.0.1';
export const DEFAULT_BOOTSTRAP_DNS = '8.8.8.8\n8.8.4.4\n1.1.1.1\n1.0.0.1\n223.5.5.5';
export const DEFAULT_UPSTREAM_TIMEOUT = 1;
export const DEFAULT_UPSTREAM_MODE = DNS_REQUEST_OPTIONS.PARALLEL;
