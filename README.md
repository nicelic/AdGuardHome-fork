...
<p align="center">
  ...
  <a href="https://github.com/nicelic/AdGuardHome-fork/wiki">Wiki</a> |
  <a href="https://github.com/AdguardTeam/AdGuardHome">Upstream</a> |
  <a href="https://reddit.com/r/Adguard">Reddit</a> |
  <a href="https://twitter.com/AdGuard">Twitter</a> |
  <a href="https://t.me/adguard_en">Telegram</a>
  <br/><br/>
  <a href="https://codecov.io/github/nicelic/AdGuardHome-fork?branch=main">
    <img src="https://img.shields.io/codecov/c/github/nicelic/AdGuardHome-fork/main.svg" alt="Code Coverage"/>
  </a>
  <a href="https://goreportcard.com/report/github.com/nicelic/AdGuardHome-fork">
    <img src="https://goreportcard.com/badge/github.com/nicelic/AdGuardHome-fork" alt="Go Report Card"/>
  </a>
  <br/>
  <a href="https://github.com/nicelic/AdGuardHome-fork/releases">
    <img src="https://img.shields.io/github/release/nicelic/AdGuardHome-fork/all.svg" alt="Latest release"/>
  </a>
</p>
<br/>
<p align="center">
  ...
  maintained at
  <a href="https://github.com/nicelic/AdGuardHome-fork">nicelic/AdGuardHome-fork</a>.
</p>
<br/>
<p align="center">
...
```sh
curl -s -S -L https://raw.githubusercontent.com/nicelic/AdGuardHome-fork/main/scripts/install.sh | sh -s -- -v
```

To install with `wget` run the following command:

```sh
wget --no-verbose -O - https://raw.githubusercontent.com/nicelic/AdGuardHome-fork/main/scripts/install.sh | sh -s -- -v
```

To install with `fetch` run the following command:

```sh
fetch -o - https://raw.githubusercontent.com/nicelic/AdGuardHome-fork/main/scripts/install.sh | sh -s -- -v
```
...
You can use the upstream official Docker image on [Docker Hub], or publish a
fork-specific image from this repository.

#### <a href="#snap-store" id="snap-store" name="snap-store">Snap Store</a>

If you're running **Linux,** you can use the upstream official Snap package from
the [Snap Store], or build a fork-specific Snap package from this repository.
...
[wiki]: https://github.com/nicelic/AdGuardHome-fork/wiki
...
[openapi]:  https://github.com/nicelic/AdGuardHome-fork/tree/main/openapi
...
Is there a chance to handle this in the future?  DNS will never be enough to do this. The upstream AdGuard Home project is [tracking][issue-1228] this feature support. Unfortunately, even in this case, there still will be cases when this won't be enough or would require quite a complicated configuration.
...
```sh
git clone https://github.com/nicelic/AdGuardHome-fork
cd AdGuardHome-fork
make
```
...
[src-makefile]: https://github.com/nicelic/AdGuardHome-fork/blob/main/Makefile
[targ-docker]:  https://github.com/nicelic/AdGuardHome-fork/tree/main/scripts#build-dockersh-build-a-multi-architecture-docker-image
[targ-release]: https://github.com/nicelic/AdGuardHome-fork/tree/main/scripts#build-releasesh-build-a-release-for-all-platforms
...
[pr]:    https://github.com/nicelic/AdGuardHome-fork/pulls
...
3. Standalone builds. Use the automated installation script or look for the available builds [on the Wiki][wiki-platf].
   ...
   ```sh
   curl -s -S -L https://raw.githubusercontent.com/nicelic/AdGuardHome-fork/main/scripts/install.sh | sh -s -- -c beta
   ```

   Script to install an edge version:

   ```sh
   curl -s -S -L https://raw.githubusercontent.com/nicelic/AdGuardHome-fork/main/scripts/install.sh | sh -s -- -c edge
   ```

[wiki-platf]: https://github.com/nicelic/AdGuardHome-fork/wiki/Platforms
...
[iss]: https://github.com/nicelic/AdGuardHome-fork/issues
...
[iss-help]: https://github.com/nicelic/AdGuardHome-fork/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22
...
[src-packagejson]: https://github.com/nicelic/AdGuardHome-fork/blob/main/client/package.json
