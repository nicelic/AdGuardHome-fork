...
func TestQueryLog_DecodeLogEntry_success(t *testing.T) {
	...
	want := &logEntry{
		...
		ClientID:          "cli42",
		ClientProto:       "",
		ClientTransport:   ClientTransportUDP,
		ReqECS:            "1.2.3.0/24",
		Answer:            ans,
		Cached:            true,
		Result:            result,
...
func TestQueryLog_DecodeLogEntry(t *testing.T) {
	...
	testCases := []struct {
		...
		name: "bad_client_transport",
		log:  `{"IP":"127.0.0.1","T":"2020-11-25T18:55:56.519796+03:00","QH":"an.yandex.ru","QT":"A","QC":"IN","CT":8,"Answer":"Qz+BgAABAAEAAAAAAmFuBnlhbmRleAJydQAAAQABwAwAAQABAAAACgAEAAAAAA==","Result":{"IsFiltered":true,"Reason":3},"Elapsed":837429}`,
		want: "",
	}, {
		name: "very_bad_client_transport",
		log:  `{"IP":"127.0.0.1","T":"2020-11-25T18:55:56.519796+03:00","QH":"an.yandex.ru","QT":"A","QC":"IN","CT":"icmp","Answer":"Qz+BgAABAAEAAAAAAmFuBnlhbmRleAJydQAAAQABwAwAAQABAAAACgAEAAAAAA==","Result":{"IsFiltered":true,"Reason":3},"Elapsed":837429}`,
		want: `level=DEBUG msg="decoding log entry; handler" err="invalid client transport: \"icmp\""`,
	}, {
		name: "bad_answer",
