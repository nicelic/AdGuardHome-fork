...
import (
	...
	"github.com/nicelic/AdGuardHome-fork/internal/aghrenameio"
...
func (d *DNSFilter) enableFiltersLocked(ctx context.Context, async bool) {
	...
	blockFilters := make([]Filter, 0, len(d.conf.Filters))
	...
	err := d.setFilters(ctx, userFilter, blockFilters, allowFilters, async)
	if err != nil {
