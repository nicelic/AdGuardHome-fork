...
type jsonDNSConfig struct {
	...
	// DisableIPv4 defines if IPv4 addresses should be dropped.
...
const (
	// jsonUpstreamModeEmpty is the legacy empty representation of
...
func (s *Server) setConfig(dc *jsonDNSConfig) (shouldRestart bool) {
	...
	setIfNotNil(&s.conf.ADisabled, dc.DisableIPv4)
