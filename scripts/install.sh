...
configure() {
	...
	if [ "$channel" = 'release' ]; then
		url="https://github.com/nicelic/AdGuardHome-fork/releases/latest/download/${pkg_name}"
	else
		url="https://github.com/nicelic/AdGuardHome-fork/releases/download/${channel}/${pkg_name}"
	fi
...
rerun_with_root() {
	script_url='https://raw.githubusercontent.com/nicelic/AdGuardHome-fork/main/scripts/install.sh'
	readonly script_url
