...
version_download_url="https://github.com/nicelic/AdGuardHome-fork/releases/download/${version}"
...
if [ "$channel" = 'edge' ]; then
	announcement_url='https://github.com/nicelic/AdGuardHome-fork/wiki/Platforms'
else
	announcement_url="https://github.com/nicelic/AdGuardHome-fork/releases/tag/${version}"
fi
